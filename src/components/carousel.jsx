            ...
            >
                ...
                <SwiperSlide>
                    ...
                    <div className='slide-item'>
                        <div className="geometricA"></div>
                        <div className="geometricB"></div>
                        <div className="title-slide-item">Margarita Island</div>
                ...
                <SwiperSlide>
                    <div className='slide-item'>
                        <div className="geometricA"></div>
                        <div className="geometricB"></div>
                        <div className="title-slide-item">Ciudad</div>
                        <div className="subtitle-slide-item">Pais</div>
                        <img alt="imagen Singapur" src={Singapur} />
                    </div>
                    <div className='slide-item'>
                        <div className="geometricA"></div>
                        <div className="geometricB"></div>
